...
export const STRINGS: Record<Lang, Record<string, string>> = {
  es: {
    ...
    suggestionsSubject: 'Sugerencia SUSHITAP',
    a11yMenu: 'Abrir ajustes',
    a11yHistory: 'Abrir historial',
    a11yClose: 'Cerrar',
    a11yEat: 'Comer una pieza de sushi',
  },
  en: {
    eaten: 'Today you ate',
    ...
    suggestionsSubject: 'SUSHITAP suggestion',
    a11yMenu: 'Open settings',
    a11yHistory: 'Open history',
    a11yClose: 'Close',
    a11yEat: 'Eat one sushi piece',
  },
  ca: {
    ...
    suggestionsSubject: 'Suggeriment SUSHITAP',
    a11yMenu: 'Obre els ajustos',
    a11yHistory: "Obre l'historial",
    a11yClose: 'Tanca',
    a11yEat: 'Menja una peça de sushi',
  },
  fr: {
    ...
    suggestionsSubject: 'Suggestion SUSHITAP',
    a11yMenu: 'Ouvrir les paramètres',
    a11yHistory: "Ouvrir l'historique",
    a11yClose: 'Fermer',
    a11yEat: 'Manger une pièce de sushi',
  },
  it: {
    ...
    suggestionsSubject: 'Suggerimento SUSHITAP',
    a11yMenu: 'Apri impostazioni',
    a11yHistory: 'Apri cronologia',
    a11yClose: 'Chiudi',
    a11yEat: 'Mangia un pezzo di sushi',
  },
  de: {
    ...
    suggestionsSubject: 'SUSHITAP-Vorschlag',
    a11yMenu: 'Einstellungen öffnen',
    a11yHistory: 'Verlauf öffnen',
    a11yClose: 'Schließen',
    a11yEat: 'Ein Sushi-Stück essen',
  },
  ja: {
    eaten: '今日食べたのは',
    pieces: '個の寿司',
    ...
    suggestionsSubject: 'SUSHITAPへのご意見',
    a11yMenu: '設定を開く',
    a11yHistory: '履歴を開く',
    a11yClose: '閉じる',
    a11yEat: '寿司を1つ食べる',
